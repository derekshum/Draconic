!snippet transmuted tembed
<drac2>
ability_name = "Transmuted Spell"
...
if cc_value_1 + cc_value_2 > 0:
    ...
    return_string = (
        f'-f "{ability_name}|When you cast a spell that deals a type of damage from the following list, you can spend 1 sorcery point to change that damage type to one of the other listed types: acid, cold, fire, lightning, poison, thunder." '
        )
else:
    return_string = (
