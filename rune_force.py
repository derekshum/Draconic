...
if cc_value >= cc_request:
    ...
    return_string = (
        ...
        f' -desc "When you make an attack with the ~~whip~~ dagger and hit, you can use your reaction to invoke the ~~whip\'s~~ dagger\'s rune. Doing so increases the extra ~~fire~~ force damage dealt by the whip to 2d6." '
