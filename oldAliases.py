...
-f "{{cc}} ({{1 if sufficientCC else 0}} used)| {{character().cc_str(cc) if counterExists else f'No {cc} counter.'}}|inline"
...
-f "{{cc}} ({{1 if sufficientKi else 0}} used)| {{character().cc_str(cc) if kiCounterExists else f'No {cc} counter.'}}|inline"
...
-f "{{cc}} ({{kiSpend if legalKi else 0}} used)| {{character().cc_str(cc) if kiCounterExists else f'No {cc} counter.'}}|inline"
...
-f "{{cc1}} (-{{1 if go else 0}})|{{character().cc_str(cc1) if counterExists1 else f'No {cc1} counter.'}}|inline"
-f "{{cc2}} (-{{1 if go else 0}})|{{character().cc_str(cc2) if counterExists2 else f'No {cc2} counter.'}}|inline"
-footer "{{ctx.prefix}}{{ctx.alias}}"
...
-f "{{cc}} ({{2 if sufficientKi else 0}} used)| {{character().cc_str(cc) if kiCounterExists else f'No {cc} counter.'}}|inline"
-footer "{{ctx.prefix}}{{ctx.alias}}"
